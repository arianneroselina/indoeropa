			...
			<div className="max-w-screen-xl mx-auto px-4">
				<div className="text-center mb-12 animate__animated animate__fadeIn animate__delay-1s">
					...
					<p className="subtext mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
						...
						service provider in Europe, based in Germany and
						Indonesia. We ensure that your goods are delivered
				...
				<div className="flex justify-between items-center pt-16 mb-16 animate__animated animate__fadeIn animate__delay-2s">
					<div className="w-full md:w-1/2">
						...
						<p className="subtext mt-4 mr-4 text-lg text-gray-600">
							We offer the most reliable luggage shipping service.
							Your items are delivered directly by our trusted
							team, ensuring that they arrive safely and on time.
						</p>
						<a
							href="/shipment"
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
						<div className="bg-white p-8 rounded-lg shadow-lg hover:scale-105 transform transition-all duration-300">
							...
							<p className="text-gray-600">
								We handle more than 50 flights every year,
								ensuring that every item is shipped safely and
								efficiently with clear SOPs.
							</p>
						</div>
						...
						<div className="bg-white p-8 rounded-lg shadow-lg hover:scale-105 transform transition-all duration-300">
							...
							<p className="text-gray-600">
								Your items are packed with care using our secure
								packing SOPs to ensure they are safely delivered
								without any issues.
							</p>
						</div>
						...
						<div className="bg-white p-8 rounded-lg shadow-lg hover:scale-105 transform transition-all duration-300">
							...
							<p className="text-gray-600">
								Our trusted flight crew, consisting of students
								and Ausbildung participants, transports your
								luggage directly.
							</p>
						</div>
					</div>
				...
				<div className="bg-secondary text-white py-16 px-4 mb-16 rounded-lg shadow-xl">
					...
					<p className="mt-6 text-lg text-center max-w-2xl mx-auto">
						INDO EROPA is committed to providing the most reliable,
						secure, and efficient luggage shipping solutions. We are
						here to give you peace of mind while shipping your
						precious items across the world. ✈️📦
					</p>
				</div>
				...
				<div className="text-center pt-16">
					...
					<p className="subtext text-lg text-gray-600 mb-6">
						Trust us with your belongings and enjoy a seamless
						shipping experience.
					</p>
					<a
						href="/shipment"
