    ...
    setInvoiceByItem((prev) => {
      const next = {
        ...
        [key]: {
          over125,
          originalValueEur:
            over125 === "yes" ? (prev[key]?.originalValueEur ?? "") : "",
        },
      };
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <div className="subtext mb-6 rounded-xl border bg-amber-50 px-4 py-3">
            <p className="text-sm text-gray-700">
              ...
              <span className="font-semibold">original value above €125</span>,
              ...
              <span className="inline-flex items-center gap-2 relative group">
                ...
                <span
                  ...
                  "
                >
                  This fee covers customs processing, declaration handling, and
                  administrative costs required for items valued above €125.
                </span>
              </span>
            </p>
          </div>
          ...
          <form onSubmit={handleContinue} className="space-y-6">
            <div className="space-y-4">
              {relevant.map(({ item, idx, key }) => {
                ...
                const fee =
                  entry.over125 === "yes" &&
                  Number.isFinite(Number(entry.originalValueEur))
                    ...
                    <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                      ...
                      >
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setOriginalValue(key, e.target.value)
                          }
                      ...
                      >
                        ...
                        <input
                          ...
                          className="subtext w-full p-3 border border-gray-300 rounded-xl input-focus"
                          onChange={(e) =>
                            setProofFile(key, e.target.files?.[0] ?? null)
                          }
                          required={entry.over125 === "yes"}
                        />
                      </div>
