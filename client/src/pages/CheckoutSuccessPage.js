                    ...
                    <div className="mt-8 rounded-2xl border bg-gray-50 p-5">
                        ...
                        <div className="mt-4 space-y-2">
                            {fullName && (
                                <div className="flex items-center justify-between">
                                    <span className="subtext text-sm text-gray-600">Name</span>
                            ...
                            {typeof itemsCount === "number" && (
                                <div className="flex items-center justify-between">
                                    <span className="subtext text-sm text-gray-600">Shipments</span>
                            ...
                            {totalAmountEUR != null && (
                                <div className="flex items-center justify-between">
                                    <span className="subtext text-sm text-gray-600">Total (EUR)</span>
                                    <span className="text-sm font-semibold text-gray-900">
                            ...
                            {totalAmountIDR != null && (
                                <div className="flex items-center justify-between">
                                    <span className="subtext text-sm text-gray-600">Total (IDR)</span>
                                    <span className="text-sm font-semibold text-gray-900">
                                        IDR {Number(totalAmountIDR).toLocaleString()}
                                    </span>
                                </div>
                            )}
                            ...
                            {paidViaLabel && (
                                <div className="flex items-center justify-between">
                                    <span className="subtext text-sm text-gray-600">Payment</span>
                                    <span className="text-sm font-semibold text-gray-900">{paidViaLabel}</span>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="mt-4">
                            <p className="subtext text-xs text-gray-500">
                                Next step: We’ll confirm your pickup and follow up if we need any extra details.
                            </p>
                        </div>
                    </div>
