		...
		>
			...
			<div className="max-w-screen-xl mx-auto px-4 text-center relative z-10">
				...
				<p className="subtext text-lg text-white mb-8 max-w-3xl mx-auto">
					...
					information, or just want to discuss your shipping needs,
					feel free to reach out to us.
				</p>
				<p className="subtext text-lg text-white mb-8 max-w-3xl mx-auto">
					At INDO EROPA, we're committed to providing you with the
					best and most reliable luggage shipping services. Our team
					is always ready to assist you with any inquiries.
				</p>
				<Link to="/contact" className="button-primary font-semibold">
					Contact Us
				</Link>
			</div>
		</section>
